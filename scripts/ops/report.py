...
from scripts.ops.common import ROOT, load_yaml, resolve_latest_weight
...
def cmd_report() -> None:
    ...
    distill_best = resolve_latest_weight(ROOT / distill_cfg["train"]["project"], str(distill_cfg["train"]["name"]))
    prune_finetune_best = resolve_latest_weight(
    ...
    lines.append("")
    lines.append("> Auto-generated by `python3 scripts/cli.py report`. Do not edit metrics manually.")
    lines.append("")
